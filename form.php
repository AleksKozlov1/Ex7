...
<body style="background-color:aquamarine">
    <div class="container-fluid container-md">
        <div class="row m-1 p-1 justify-content-center">
            <div class="col-sm-4">
                <div id="navbar">
                    <nav class="navbar navbar-light" style="background-color:aqua; border-radius: 15px;">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#" style="color:blue;">Form</a>
                            </li>
                            <li class="nav-item">
                ...
                <div id="forma" class="col m-1 p-1 rounded-3 border border-dark d-flex justify-content-center text-center" style="background-color:darkturquoise;">

...
<body style="background-color:aquamarine;">
    <div id="main" class="container-fluid container-md">
        <div class="row m-1 p-1 justify-content-center">
            <div class="col-sm-4">
                <?php
                print('<div class="container alert alert-info" role="alert">Вы успешно авторизовались и видите защищенные паролем данные.</div>');
                ?>
                <div>
                ...
                <div id="db_del_input" class="col m-1 p-1 rounded-3 border border-dark" style="background-color:aqua;">
                ...
                <div id="db_del_input" class="col m-2 p-2 rounded-3 border border-dark" style="background-color:aqua;">
                ...
                <div id="statistic" class="rounded-3 border border-dark" style="background-color:aqua;">
            ...
            <div class="row justify-content-center m-1 p-1">
                <div id="db_table" class="col-12 col-md-8 bg-light rounded-3 border border-dark" style="background-color:aqua;">
